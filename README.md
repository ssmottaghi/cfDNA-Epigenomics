...
## 1. cfDNA-analysis:
This folder contains the bioinformatics pipeline used to process cfDNA data and extract normalized depth at specified genomic regions.
...
## 2. Model_Development:
This folder contains the code for signature matrix construction and model training.
